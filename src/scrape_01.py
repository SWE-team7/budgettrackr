...
def parse(link):
    ...
    """
    this section of try + catch statements parses the requested URL 
    for the specific element id's and classes we want to save: 
    product, price, rating, num of ratings and converts them to a string
    """
