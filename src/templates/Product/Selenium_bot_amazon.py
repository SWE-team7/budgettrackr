...
def Amazon(input):
    ...
    productName = browser.find_element("id", "productTitle").text
    productPrice = browser.find_element(By.CLASS_NAME, "a-price-symbol").text, browser.find_element(By.CLASS_NAME, "a-price-whole").text,".", browser.find_element(By.CLASS_NAME, "a-price-fraction").text
    productDesc = browser.find_element("id", "productDetails_detailBullets_sections1").text
